...
<body>
    ...
    <div class="contenedor-grande" id="menu">
        ...
        <div id="botones">
            ...
            <a class="boton-menu" id="boton-cuestionarios" href="./vista-formularios-alumno.php">Formularios</a>
            <a class="boton-menu" id="boton-actividades" href="./vista-actividades-alumno.php">Actividades</a>
